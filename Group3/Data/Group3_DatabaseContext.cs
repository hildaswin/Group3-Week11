        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ClassSchedule>(entity =>
            {
                entity.HasKey(e => new { e.ClassId, e.WeekDayId })
                    .HasName("PK__ClassSch__7237021F0B4C4B39");
                ...
                entity.HasOne(d => d.Class)
                    ...
                    .HasConstraintName("FK__ClassSche__Class__38996AB5");

                entity.HasOne(d => d.WeekDay)
                    .WithMany(p => p.ClassSchedules)
                    .HasForeignKey(d => d.WeekDayId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ClassSche__WeekD__398D8EEE");
            });

            modelBuilder.Entity<ClassTable>(entity =>
            {
                entity.HasKey(e => e.ClassId)
                    .HasName("PK__ClassTab__CB1927C0249CAF0A");
                ...
                entity.HasOne(d => d.Course)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ClassTabl__Cours__32E0915F");

                entity.HasOne(d => d.Instructor)
                    .WithMany(p => p.ClassTables)
                    .HasForeignKey(d => d.InstructorId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ClassTabl__Instr__33D4B598");

                entity.HasOne(d => d.Room)
                    .WithMany(p => p.ClassTables)
                    .HasForeignKey(d => d.RoomId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ClassTabl__RoomI__35BCFE0A");
            });
            ...
            modelBuilder.Entity<Course>(entity =>
            {
                ...
                entity.HasOne(d => d.Subject)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Course__SubjectI__300424B4");
            });
            ...
            modelBuilder.Entity<Status>(entity =>
            {
                entity.HasKey(e => e.ClassStatusCode)
                    .HasName("PK__Status__F727C6A834DD12EA");
            ...
            modelBuilder.Entity<StudentClass>(entity =>
            {
                entity.HasKey(e => new { e.ClassId, e.StudentId })
                    .HasName("PK__StudentC__4835757973649FAF");
                ...
                entity.HasOne(d => d.Class)
                    ...
                    .HasForeignKey(d => d.ClassId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__StudentCl__Class__3E52440B");

                entity.HasOne(d => d.Student)
                    .WithMany(p => p.StudentClasses)
                    .HasForeignKey(d => d.StudentId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__StudentCl__Stude__3F466844");
            });
